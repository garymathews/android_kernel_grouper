...
int user_mv_table[MAX_DVFS_FREQS] = {
	800, 825, 850, 875, 900, 912, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1250, 1300, 1350, 1400};
#endif
...
static const int cpu_millivolts[MAX_DVFS_FREQS] = {
	800, 825, 850, 875, 900, 912, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1259, 1300, 1350, 1400};
...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  7, 0, MHZ, 550, 550, 770, 770,  910,  910, 1150, 1230, 1280, 1330, 1370, 1400, 1500, 1600, 1700, 1800),
	CPU_DVFS("cpu_g",  7, 1, MHZ, 550, 550, 770, 770,  910,  910, 1150, 1230, 1280, 1330, 1370, 1400, 1500, 1600, 1700, 1800),
	CPU_DVFS("cpu_g",  7, 2, MHZ, 550, 550, 770, 770,  910,  910, 1150, 1230, 1280, 1330, 1370, 1400, 1500, 1600, 1700, 1800),
	CPU_DVFS("cpu_g",  7, 3, MHZ, 550, 550, 770, 770,  910,  910, 1150, 1230, 1280, 1330, 1370, 1400, 1500, 1600, 1700, 1800),
	CPU_DVFS("cpu_g",  7, 4, MHZ, 550, 550, 770, 770,  910,  910, 1150, 1230, 1280, 1330, 1370, 1400, 1500, 1600, 1700, 1800),
...
static struct dvfs core_dvfs_table[] = {
...
#endif
	CORE_DVFS("cpu_lp", lp_cpu_millivolts, 2, 1, KHZ,   204000, 295000, 370000, 428000, 475000,  513000,  579000,  620000,  620000),
	CORE_DVFS("cpu_lp", lp_cpu_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  450000,  450000,  450000),

	CORE_DVFS("emc", emc_millivolts,    0, 1, KHZ,        1, 266500, 266500, 266500, 266500,  533000,  533000,  533000,  533000),
	CORE_DVFS("emc", emc_millivolts,    1, 1, KHZ,   102000, 408000, 408000, 408000, 408000,  667000,  667000,  667000,  667000),
	CORE_DVFS("emc", emc_millivolts,    2, 1, KHZ,   102000, 408000, 408000, 408000, 408000,  667000,  667000,  800000,  900000),
	...
	CORE_DVFS("vi", core_millivolts,     1, 1, KHZ,        1, 216000, 267000, 300000, 371000,  409000,  409000,  409000,  409000),
...
/* Core voltages (mV):					    950,   1000,   1050,   1100,   1150,    1200,    1250,    1300,    1350 */
	...
	CORE_DVFS("2d", avp_millivolts,     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("epp", avp_millivolts,    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("3d", avp_millivolts,     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("3d2", avp_millivolts,    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	...
	CORE_DVFS("2d", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("epp", avp_millivolts,    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("3d", avp_millivolts,     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("3d2", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("se", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
#endif
#ifdef CONFIG_GPU_OC_484
	CORE_DVFS("vde", avp_millivolts,    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("mpe", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("2d", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("epp", avp_millivolts,    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("3d", avp_millivolts,     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("3d2", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("se", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
#endif
#ifdef CONFIG_GPU_OC_520
	CORE_DVFS("vde", avp_millivolts,    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("mpe", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("2d", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("epp", avp_millivolts,    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("3d", avp_millivolts,     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("3d2", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("se", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
#endif
	...
	CORE_DVFS("vde", avp_millivolts,    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("mpe", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("2d", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("epp", avp_millivolts,    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("3d", avp_millivolts,     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("3d2", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("se", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
#endif
#ifdef CONFIG_GPU_OC_700
	CORE_DVFS("vde", avp_millivolts,    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("mpe", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("2d", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("epp", avp_millivolts,    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("3d", avp_millivolts,     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("3d2", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("se", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
#endif
#else
	CORE_DVFS("vde", avp_millivolts,    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("mpe", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("2d", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("epp", avp_millivolts,    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("3d", avp_millivolts,     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("3d2", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("se", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
#endif

	CORE_DVFS("vde", avp_millivolts,    2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  520000,  600000),
	CORE_DVFS("mpe", avp_millivolts,    2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),
	CORE_DVFS("2d", avp_millivolts,     2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),
	CORE_DVFS("epp", avp_millivolts,    2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),
	CORE_DVFS("3d", avp_millivolts,     2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),
	CORE_DVFS("3d2", avp_millivolts,    2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),
	CORE_DVFS("se", avp_millivolts,     2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),

	CORE_DVFS("vde", avp_millivolts,    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
	CORE_DVFS("mpe", avp_millivolts,    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
	CORE_DVFS("2d", avp_millivolts,     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
	CORE_DVFS("epp", avp_millivolts,    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
	CORE_DVFS("3d", avp_millivolts,     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
